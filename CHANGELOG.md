...
- Breaking: `SpannedError` now stores the full error span from `span: Span { start: Position, end: Position }`, to facilitate, E.G., language servers highlighting syntax errors.
