...
- Fix issue [#241](https://github.com/ron-rs/ron/issues/241) and allow parsing numbers with explicit type suffixes, e.g. `1u8` or `-1_f32` ([#481](https://github.com/ron-rs/ron/pull/481))
- Add `number_suffixes` option to `PrettyConfig` to allow serialising numbers with their explicit type suffix, e.g. `42_i32` ([#481](https://github.com/ron-rs/ron/pull/481))
